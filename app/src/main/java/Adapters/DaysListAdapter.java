...
public class DaysListAdapter extends RecyclerView.Adapter<DaysListAdapter.DayVH> {
    ...
    public DaysListAdapter(ArrayList<DayDetails> data) {
        this.data = data;
    ...
    public void onBindViewHolder(DayVH holder, int position) {
        ...
        holder.timezoneTV_headline.setText(WeatherInfo.timeZone);
        holder.timezoneTV_content.setText(WeatherInfo.timeZone);
        ...
        holder.humidityTV_headline.setText(String.valueOf((int) currentDay.getHumidity()));
        holder.humidityTV_content.setText(String.valueOf((int) currentDay.getHumidity()));
